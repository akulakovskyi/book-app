...
const dict = {
  en: {
    ...
    'results.swap': 'Replace',
    'results.swapOpen': 'Choose replacement',
    'results.swapClose': 'Close',
    'results.swapReset': 'Restore original',
    'results.swapEmpty': 'No other listings of this size available.',
    'results.customized': 'changed',
  ...
  ua: {
    ...
    'results.swap': 'Замінити',
    'results.swapOpen': 'Обери заміну',
    'results.swapClose': 'Закрити',
    'results.swapReset': 'Повернути оригінал',
    'results.swapEmpty': 'Більше немає варіантів цього розміру.',
    'results.customized': 'змінено',
